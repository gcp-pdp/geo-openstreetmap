#!/bin/bash
#OSM_URL=https://storage.googleapis.com/gcp-pdp-osm-dev-work/history-latest-singapore.pbf
#OSM_MD5_URL=https://storage.googleapis.com/gcp-pdp-osm-dev-work/history-latest-singapore.pbf.md5
REGION_LOCATION=us-east1
SUFFIX=historyeast1
#
...
#ADDITIONAL_POOL_MACHINE_TYPE=n1-highmem-32
#ADDITIONAL_POOL_NUM_NODES=1
#ADDITIONAL_POOL_DISK_SIZE=3000
